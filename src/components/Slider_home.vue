<template>
	<div class="m-carousel">
		<div class="m-carousel-wrapper" :style="ulStyle">
			<div class="m-carousel-item" :style="{width:100/count + '%'}" v-for="(item,index) in items" :key="index">
		...
		<div v-if="showDots">
			<div class="dots-wrapper">
				<span class="carousel-dot" v-for="(i,index) in count" :key="index" :class="{'carousel-dot-selected':(currentIndex === i)}"
